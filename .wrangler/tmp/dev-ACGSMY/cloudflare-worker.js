(() => {
  ...
  // .wrangler/tmp/bundle-Cd46Jv/checked-fetch.js
...
`
  ...
  // .wrangler/tmp/bundle-Cd46Jv/middleware-insertion-facade.js
  ...
  async function handleRequest(request) {
    ...
    newResponse.headers.set("Access-Control-Allow-Headers", "Content-Type, x-auth-token, x-application-key, authorization");
    return newResponse;
  }
